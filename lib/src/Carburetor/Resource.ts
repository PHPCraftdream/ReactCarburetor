...
import {IUpdateScheduler} from "./Models";
 ...
 */
export class ResourceCarburetor<T, TArgs = undefined> extends Carburetor<IResourceData<T>> {
    ...
    public load = (args: TArgs, deferNotification: boolean = false): Promise<void> => {
