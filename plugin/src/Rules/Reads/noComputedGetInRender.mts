...
/**
 * Read a computed in render through useComputed, not through get().
 *
 ...
 * and native/src/rules/ for the rule itself. See docs/hazards.md, H2.
 */
export const noComputedGetInRender: IRule = nativeRule(
